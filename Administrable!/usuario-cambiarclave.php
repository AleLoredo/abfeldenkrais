...
<div id="wrap">
	...
	<ul id="nav">
      ...
      <li class="active"><a href="usuarios.php?nocache=<?php echo time(); ?>">Usuarios</a></li>
    </ul>
	</div>
	...
	<div id="content-wrap">
		...
		<div id="content">
			...
			<form action="usuario-cambiarclave-guardar.php" method="post"><table class="table1">
			<thead>
				<tr>
				<th colspan="2">Cambiar Clave</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
				<th width="50" class="sub">Usuario</th>
				...
				<tr>
				  ...
				  <td><input name="clave" type="text" id="clave" value="<?php echo $Busqueda["clave"]; ?>" size="100" maxlength="100" /></td>
			  </tr>
				<tr>
				  <th class="sub">&nbsp;</th>
            ...
            <p><a href="home.php?nocache=<?php echo time(); ?>"><img src="images/volver.png" /></a></p>
